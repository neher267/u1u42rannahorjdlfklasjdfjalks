	...
	<div class="panel panel-widget forms-panel">
		<div class="forms">
			<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
				...
				<div class="col-md-12">
					<a href="{{route('category.images.index',$category)}}" class="btn btn-default">Back</a>
				...
				<div class="form-body">
					<form action="{{route('category.images.store', $category)}}" method="POST" enctype="multipart/form-data">
					{{ csrf_field() }}					
